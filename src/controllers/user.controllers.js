...
const updateAccountDetails = asynchandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, user, "Account details update Successfuly"))
});
...
const updateUserAvatar = asynchandler(async(req,res) => {
  ...
  return res.status(200).json(new ApiResponse(200, user, "Avatar update Successfuly"))
})
const updateUserCoverImage = asynchandler(async(req,res) => {
  ...
  return res.status(200).json(new ApiResponse(200, user, "coverImage update Successfuly"))
})
